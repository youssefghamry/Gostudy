            ...
            'fields' => [
                ...
                [
                    ...
                    'options' => [
                        ...
                        '2' => 'Style 2',
                        '3' => 'Style 3',
                        'default_plugin_style' => 'Default Plugin Style',
                    ],
                    'default' => '1',
                ],
                [
    ...
    Redux::setSection(
        ...
        [
            ...
            'fields' => [
                ...
                // ],
                [
                    'id' => 'tutor_a_course_by_switch',
                    'type' => 'switch',
                    'title' => esc_html__('Use A course by (Instructor)?', 'gostudy'),
                    'default' => false,
                ],
                [
                    'id' => 'tutor_social_share_sidebar',
                    'type' => 'switch',
                    'title' => esc_html__('Use Social Shares?', 'gostudy'),
                    'default' => true,
                ],
                [
...
Redux::setSection(
 ...
 Redux::setSection(
        ...
        [
            ...
            [
                'id' => 'tutor_zindex_css-start',
                'title' => esc_html__('Tutor Popup Modal', 'gostudy'),
                'type' => 'section',
                'indent' => true,
            ],
            [   
                'id' => 'tutor_z_index_css',
                'title' => esc_html__('Enable Modal z-index CSS', 'gostudy'),
                'type' => 'switch',
                'on' => esc_html__('Enable', 'gostudy'),
                'off' => esc_html__('Disable', 'gostudy'),
                'default' => true,
