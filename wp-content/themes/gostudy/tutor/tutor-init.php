<?php
                       ...
                       <?php if ( !$disable_course_author){ 
                        ...
                        ?>
                          <div class="tutor-single-course-avatar">
                            <a href="<?php echo esc_url($profile_url) ?>"> <?php echo get_avatar( get_the_author_meta( 'ID' ), 60 ); ?> </a>
                          </div>
    ...
    <div class="tutor-single-course-meta tutor-meta-top">
         ...
         <?php if ( !$disable_course_author){ ?>
           ...
           <div class="tutor-course-level">
              ...
              <div class="meta-value">  <a href="<?php echo esc_url($profile_url) ?>"> <?php echo get_the_author(); ?></a></div>
           </div>
   ...
   <?php if ( !$tutor_single_hide_language){ ?>
    ...
    function gostudy_course_instructor(){ 

          $tutor_a_course_by_switch = Gostudy_Theme_Helper::get_mb_option('tutor_a_course_by_switch');

         if ( $tutor_a_course_by_switch){ ?>
    ...
    add_action('tutor_course/single/before/material_includes', 'gostudy_course_instructor', 1);
    ...
    function gostudy_social_shear_for_sidebar(){ 
        ...
        $tutor_social_share_sidebar = Gostudy_Theme_Helper::get_mb_option('tutor_social_share_sidebar');

         if ( $tutor_social_share_sidebar){ ?>
