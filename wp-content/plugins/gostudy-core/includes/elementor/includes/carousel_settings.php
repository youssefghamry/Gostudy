...
if (!class_exists('RT_Carousel_Settings')) {
    /**
     * RT Elementor Carousel Settings
     *
     *
        ...
        public static function options($self, $array = [])
        {
	        ...
	        if (isset($array['rt_motion']) && $array['rt_motion'] === true) {
		        ...
		        $self->add_responsive_control(
			        'motion_style_height',
			        [
				        'label' => esc_html__( 'Carousel Height', 'gostudy-core' ),
