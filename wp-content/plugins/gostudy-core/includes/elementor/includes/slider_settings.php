...
if (!class_exists('RT_Slider_Settings')) {
    /**
     * RT Elementor Slider Settings
     *
     *
    ...
    class RT_Slider_Settings
    {
        ...
        public static function options($self, $array = [])
        {
            ...
            $self->start_controls_section(
                'rt_carousel_section',
                ['label' => esc_html__('Slider Options', 'gostudy-core')]
            );

            $self->add_control(
                'use_carousel',
                [
                    'label' => esc_html__('Use Slider', 'gostudy-core'),
            ...
            if (isset($array['rt_motion']) && $array['rt_motion'] === true) {
                $self->add_control(
                    ...
                    [
                        ...
                        'options' => [
                            ...
                            'vertical' => esc_html__('Vertical Style', 'gostudy-core'),
                            'horizontal' => esc_html__('Hozirontal Style', 'gostudy-core'),
                        ],
                        'default' => 'default',
                    ]
                );
                ...
                $self->add_responsive_control(
                    'motion_style_height',
                    [
                        'label' => esc_html__( 'Slider Height', 'gostudy-core' ),
