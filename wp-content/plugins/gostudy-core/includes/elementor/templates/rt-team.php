<?php
/*
 * This template can be overridden by copying it to yourtheme/gostudy-core/elementor/templates/rt-team.php.
*/
                ...
                if ($featured_image) { ?>
                    <div class="team__media-wrapper">
                        <div class="team__image-wrapper"><?php
                            echo $featured_image;
	                        if (!$hide_soc_icons) echo $icons_wrap; ?>
                        </div>
                    </div>
                    <?php
                }
