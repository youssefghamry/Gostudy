<?php
/*
 * This template can be overridden by copying it to yourtheme/gostudy-core/elementor/templates/rt-courses-ld.php.
*/
...
class RT_Courses_LearnDash_3
{
    ...
    public function _render_course_post($attributes)
    {
        ...
        echo '</div>'; // course topic quiz info
