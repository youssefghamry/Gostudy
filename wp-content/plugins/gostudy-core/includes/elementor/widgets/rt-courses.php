...
use RTAddons\Templates\RTCoursesLP;
use RTAddons\Templates\RTCoursesLP_2;
use RTAddons\Templates\RTCoursesLP_3;

class RT_Courses extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('LearnPress Courses', 'gostudy-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'see_more_btn_text',
            [
                'label'   => __( 'See More', 'gostudy-core' ),
                'type'    => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('See More','gostudy-core'),
   ...
   /*-----------------------------------------------------------------------------------*/
    ...
    protected function render()
    {
        ...
        if (class_exists('LearnPress')) {
            ...
            if ($atts['layout'] == '3') {
               $courses = new RTCoursesLP_3();
               // if (class_exists('LearnPress')) {
                    echo $courses->render($atts, $this);
               // }
            }
            elseif ($atts['layout'] == '2') {
               $courses = new RTCoursesLP_2();
               // if (class_exists('LearnPress')) {
                    echo $courses->render($atts, $this);
                //}
            } else {
               $courses = new RTCoursesLP();
               // if (class_exists('LearnPress')) {
                    echo $courses->render($atts, $this);
               // }
            }
