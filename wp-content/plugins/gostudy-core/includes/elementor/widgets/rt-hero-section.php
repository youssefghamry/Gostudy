...
class RT_Hero_Section extends Widget_Base
{
    public function get_name()
    {
        return 'rt-here-section';
    }

    public function get_title()
    {
        return esc_html__('RT Hero Section', 'gostudy-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rt-hero-section',
            ]
        );
        $this->add_responsive_control(
        ...
        <div class="gostudy-container">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    ...
                    <?php endif;?>
                    <?php if ($settings['icon_text_active']): ?>
                    <?php 
