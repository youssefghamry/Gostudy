(function( $ ) {
	...
	/* Radio Image Select */
	jQuery( document ).on('click', '.rt-radio-image label', function(e){   
	...
	jQuery( window ).on( 'elementor:init', function() {
		...
		var RTControlIconView = elementor.modules.controls.Select2.extend( {

			initialize: function initialize() {
				RTControlSelect2View.prototype.initialize.apply(this, arguments);
				this.filterIcons();
			},
		...
		elementor.addControlView( 'rt-icon', RTControlIconView );
	
		var RTControlSelect2View = elementor.modules.controls.Select2;

		RTControlSelect2View.extend({
			_enqueuedFonts: [],
